<?php
    ...
    if(array_key_exists("asubmit",$_POST)){
        ...
        if ($error != "") {
          ...
          echo $subject."<br/>".$year."<br/>".$_POST['aclass']."<br/>".$_POST['asemester'];
...
<div class = "col-md-6">
        ...
        <div class = "container eg">
            ...
            <button type="submit" name="asubmit" id="button" class="btn btn-md btn-primary" disabled>Submit</button><br/>
